...
const mockProducts = [
  ...
  { id: '19', name: 'Miss Sixty Low-Rise Jeans', brand: 'Miss Sixty', category: 'pants', color: 'blue', size: 'S', year: 2003, price: 120, images: [getPlaceholderImageUrl(300, 400, 'Miss Sixty Jeans 1'), getPlaceholderImageUrl(300, 400, 'Miss Sixty Jeans 2'), getPlaceholderImageUrl(300, 400, 'Miss Sixty Jeans 3'), getPlaceholderImageUrl(300, 400, 'Miss Sixty Jeans 4')], description: 'Jeans a vita bassa Miss Sixty del 2003.', condition: 'very good', material: 'Cotton denim', measurements: { waist: '32cm', length: '98cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-miss-sixty-jeans', vestiaire: 'https://www.vestiairecollective.com/example-miss-sixty-jeans' } },
  { id: '20', name: 'Blumarine Embellished Top', brand: 'Blumarine', category: 'top', color: 'pink', size: 'M', year: 2004, price: 280, images: [getPlaceholderImageUrl(300, 400, 'Blumarine Top 1'), getPlaceholderImageUrl(300, 400, 'Blumarine Top 2'), getPlaceholderImageUrl(300, 400, 'Blumarine Top 3'), getPlaceholderImageUrl(300, 400, 'Blumarine Top 4')], description: 'Top Blumarine impreziosito in rosa del 2004.', condition: 'excellent', material: 'Silk with crystals', measurements: { chest: '44cm', length: '54cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-blumarine-top', vestiaire: 'https://www.vestiairecollective.com/example-blumarine-top' } },
  { id: '21', name: 'Diesel Distressed Jacket', brand: 'Diesel', category: 'jackets', color: 'blue', size: 'L', year: 2002, price: 180, images: [getPlaceholderImageUrl(300, 400, 'Diesel Jacket 1'), getPlaceholderImageUrl(300, 400, 'Diesel Jacket 2'), getPlaceholderImageUrl(300, 400, 'Diesel Jacket 3'), getPlaceholderImageUrl(300, 400, 'Diesel Jacket 4')], description: 'Giacca in denim distressed Diesel del 2002.', condition: 'good', material: 'Cotton denim', measurements: { chest: '58cm', length: '66cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-diesel-jacket', vestiaire: 'https://www.vestiairecollective.com/example-diesel-jacket' } },
  { id: '22', name: 'Emilio Pucci Silk Dress', brand: 'Emilio Pucci', category: 'dresses', color: 'multicolor', size: 'M', year: 2006, price: 890, images: [getPlaceholderImageUrl(300, 400, 'Pucci Dress 1'), getPlaceholderImageUrl(300, 400, 'Pucci Dress 2'), getPlaceholderImageUrl(300, 400, 'Pucci Dress 3'), getPlaceholderImageUrl(300, 400, 'Pucci Dress 4')], description: 'Abito in seta Emilio Pucci con stampa psichedelica del 2006.', condition: 'excellent', material: '100% Silk', measurements: { chest: '46cm', waist: '42cm', length: '90cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-pucci-dress' } },
  { id: '23', name: 'Gianni Versace Medusa Shirt', brand: 'Gianni Versace', category: 'top', color: 'gold', size: 'L', year: 1995, price: 1200, images: [getPlaceholderImageUrl(300, 400, 'Versace Medusa 1'), getPlaceholderImageUrl(300, 400, 'Versace Medusa 2'), getPlaceholderImageUrl(300, 400, 'Versace Medusa 3'), getPlaceholderImageUrl(300, 400, 'Versace Medusa 4')], description: 'Camicia Gianni Versace Medusa in oro del 1995.', condition: 'excellent', material: 'Silk', measurements: { chest: '54cm', length: '72cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-gianni-versace' } },
  { id: '24', name: 'Marithé Francois Girbaud Cargo Pants', brand: 'Marithé Francois Girbaud', category: 'pants', color: 'khaki', size: 'M', year: 2001, price: 150, images: [getPlaceholderImageUrl(300, 400, 'Girbaud Pants 1'), getPlaceholderImageUrl(300, 400, 'Girbaud Pants 2'), getPlaceholderImageUrl(300, 400, 'Girbaud Pants 3'), getPlaceholderImageUrl(300, 400, 'Girbaud Pants 4')], description: 'Pantaloni cargo Marithé François Girbaud del 2001.', condition: 'very good', material: 'Cotton twill', measurements: { waist: '42cm', length: '106cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-girbaud-cargo', vestiaire: 'https://www.vestiairecollective.com/example-girbaud-cargo' } },
  { id: '25', name: 'Plein Sud Bodycon Dress', brand: 'Plein Sud', category: 'dresses', color: 'black', size: 'S', year: 2003, price: 320, images: [getPlaceholderImageUrl(300, 400, 'Plein Sud Dress 1'), getPlaceholderImageUrl(300, 400, 'Plein Sud Dress 2'), getPlaceholderImageUrl(300, 400, 'Plein Sud Dress 3'), getPlaceholderImageUrl(300, 400, 'Plein Sud Dress 4')], description: 'Abito aderente Plein Sud nero del 2003.', condition: 'excellent', material: 'Viscose elastane', measurements: { chest: '40cm', waist: '34cm', length: '84cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-plein-sud-dress', vestiaire: 'https://www.vestiairecollective.com/example-plein-sud-dress' } },
  { id: '26', name: 'Faycal Amor Avant-garde Jacket', brand: 'Faycal Amor', category: 'jackets', color: 'grey', size: 'M', year: 2008, price: 280, images: [getPlaceholderImageUrl(300, 400, 'Faycal Amor Jacket 1'), getPlaceholderImageUrl(300, 400, 'Faycal Amor Jacket 2'), getPlaceholderImageUrl(300, 400, 'Faycal Amor Jacket 3'), getPlaceholderImageUrl(300, 400, 'Faycal Amor Jacket 4')], description: 'Giacca Faycal Amor avant-garde del 2008.', condition: 'very good', material: 'Wool blend', measurements: { chest: '52cm', length: '64cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-faycal-amor-jacket', vestiaire: 'https://www.vestiairecollective.com/example-faycal-amor-jacket' } },
  { id: '27', name: 'Ann Demeulemeester Draped Top', brand: 'Ann Demeulemeester', category: 'top', color: 'white', size: 'M', year: 2010, price: 380, images: [getPlaceholderImageUrl(300, 400, 'Ann D Draped Top 1'), getPlaceholderImageUrl(300, 400, 'Ann D Draped Top 2'), getPlaceholderImageUrl(300, 400, 'Ann D Draped Top 3'), getPlaceholderImageUrl(300, 400, 'Ann D Draped Top 4')], description: 'Top drappeggiato Ann Demeulemeester in bianco del 2010.', condition: 'excellent', material: 'Cotton jersey', measurements: { chest: '48cm', length: '60cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-ann-d-top', vestiaire: 'https://www.vestiairecollective.com/example-ann-d-top' } },
  { id: '28', name: 'Comme des Garçons Black Dress', brand: 'Comme des Garçons', category: 'dresses', color: 'black', size: 'L', year: 2002, price: 420, images: [getPlaceholderImageUrl(300, 400, 'CDG Dress 1'), getPlaceholderImageUrl(300, 400, 'CDG Dress 2'), getPlaceholderImageUrl(300, 400, 'CDG Dress 3'), getPlaceholderImageUrl(300, 400, 'CDG Dress 4')], description: 'Abito nero Comme des Garçons del 2002.', condition: 'very good', material: 'Wool crepe', measurements: { chest: '50cm', waist: '46cm', length: '94cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-cdg-dress', vestiaire: 'https://www.vestiairecollective.com/example-cdg-dress' } },
  { id: '29', name: 'Jean Paul Gaultier Striped Top', brand: 'Jean Paul Gaultier', category: 'top', color: 'navy blue', size: 'S', year: 2008, price: 280, images: [getPlaceholderImageUrl(300, 400, 'JPG Striped Top 1'), getPlaceholderImageUrl(300, 400, 'JPG Striped Top 2'), getPlaceholderImageUrl(300, 400, 'JPG Striped Top 3'), getPlaceholderImageUrl(300, 400, 'JPG Striped Top 4')], description: 'Top a righe Jean Paul Gaultier del 2008.', condition: 'excellent', material: 'Cotton jersey', measurements: { chest: '42cm', length: '58cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-jpg-striped', vestiaire: 'https://www.vestiairecollective.com/example-jpg-striped' } },
  { id: '30', name: 'MM6 Deconstructed Skirt', brand: 'MM6', category: 'skirts', color: 'grey', size: 'M', year: 2006, price: 180, images: [getPlaceholderImageUrl(300, 400, 'MM6 Skirt 1'), getPlaceholderImageUrl(300, 400, 'MM6 Skirt 2'), getPlaceholderImageUrl(300, 400, 'MM6 Skirt 3'), getPlaceholderImageUrl(300, 400, 'MM6 Skirt 4')], description: 'Gonna destrutturata MM6 grigia del 2006.', condition: 'excellent', material: 'Cotton blend', measurements: { waist: '40cm', length: '62cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-mm6-skirt', vestiaire: 'https://www.vestiairecollective.com/example-mm6-skirt' } },
  { id: '31', name: 'Maison Martin Margiela Split-toe Shoes', brand: 'Maison Martin Margiela', category: 'shoes', color: 'brown', size: 'XS', year: 2009, price: 520, images: [getPlaceholderImageUrl(300, 400, 'MMM Shoes 1'), getPlaceholderImageUrl(300, 400, 'MMM Shoes 2'), getPlaceholderImageUrl(300, 400, 'MMM Shoes 3'), getPlaceholderImageUrl(300, 400, 'MMM Shoes 4')], description: 'Scarpe a punta divisa Maison Martin Margiela del 2009.', condition: 'very good', material: 'Leather', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-mmm-shoes', vestiaire: 'https://www.vestiairecollective.com/example-mmm-shoes' } },
  { id: '32', name: 'John Galliano Bias Cut Dress', brand: 'John Galliano', category: 'dresses', color: 'burgundy', size: 'M', year: 2005, price: 680, images: [getPlaceholderImageUrl(300, 400, 'Galliano Bias Dress 1'), getPlaceholderImageUrl(300, 400, 'Galliano Bias Dress 2'), getPlaceholderImageUrl(300, 400, 'Galliano Bias Dress 3'), getPlaceholderImageUrl(300, 400, 'Galliano Bias Dress 4')], description: 'Abito a taglio obliquo John Galliano bordeaux del 2005.', condition: 'excellent', material: 'Silk charmeuse', measurements: { chest: '44cm', waist: '38cm', length: '88cm' }, featured: false, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-galliano-dress' } },
  { id: '33', name: 'Thierry Mugler Structured Blazer', brand: 'Thierry Mugler', category: 'jackets', color: 'black', size: 'S', year: 2009, price: 580, images: [getPlaceholderImageUrl(300, 400, 'Mugler Blazer 1'), getPlaceholderImageUrl(300, 400, 'Mugler Blazer 2'), getPlaceholderImageUrl(300, 400, 'Mugler Blazer 3'), getPlaceholderImageUrl(300, 400, 'Mugler Blazer 4')], description: 'Blazer strutturato Thierry Mugler nero del 2009.', condition: 'very good', material: 'Wool', measurements: { chest: '46cm', length: '55cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-mugler-blazer', vestiaire: 'https://www.vestiairecollective.com/example-mugler-blazer' } },
  { id: '34', name: 'Versace Jeans Couture Denim', brand: 'Versace Jeans Couture', category: 'pants', color: 'blue', size: 'M', year: 1998, price: 220, images: [getPlaceholderImageUrl(300, 400, 'Versace Jeans 1'), getPlaceholderImageUrl(300, 400, 'Versace Jeans 2'), getPlaceholderImageUrl(300, 400, 'Versace Jeans 3'), getPlaceholderImageUrl(300, 400, 'Versace Jeans 4')], description: 'Jeans Versace Jeans Couture in denim del 1998.', condition: 'good', material: 'Cotton denim', measurements: { waist: '38cm', length: '102cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-versace-jeans', vestiaire: 'https://www.vestiairecollective.com/example-versace-jeans' } },
  { id: '35', name: 'Roberto Cavalli Sheer Top', brand: 'Roberto Cavalli', category: 'top', color: 'brown', size: 'S', year: 2005, price: 350, images: [getPlaceholderImageUrl(300, 400, 'Cavalli Sheer Top 1'), getPlaceholderImageUrl(300, 400, 'Cavalli Sheer Top 2'), getPlaceholderImageUrl(300, 400, 'Cavalli Sheer Top 3'), getPlaceholderImageUrl(300, 400, 'Cavalli Sheer Top 4')], description: 'Top trasparente Roberto Cavalli del 2005.', condition: 'excellent', material: 'Silk blend', measurements: { chest: '40cm', length: '56cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-rc-sheer-top', vestiaire: 'https://www.vestiairecollective.com/example-rc-sheer-top' } },
  { id: '36', name: 'Moschino Cheap & Chic Skirt', brand: 'Moschino Cheap & Chic', category: 'skirts', color: 'yellow', size: 'M', year: 2001, price: 180, images: [getPlaceholderImageUrl(300, 400, 'Moschino Skirt 1'), getPlaceholderImageUrl(300, 400, 'Moschino Skirt 2'), getPlaceholderImageUrl(300, 400, 'Moschino Skirt 3'), getPlaceholderImageUrl(300, 400, 'Moschino Skirt 4')], description: 'Gonna Moschino Cheap & Chic gialla del 2001.', condition: 'very good', material: 'Cotton', measurements: { waist: '36cm', length: '48cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-moschino-skirt', vestiaire: 'https://www.vestiairecollective.com/example-moschino-skirt' } },
  { id: '37', name: 'Fendi Baguette Bag (Early 2000s)', brand: 'Fendi', category: 'bags', color: 'beige', size: 'one size', year: 2000, price: 950, images: [getPlaceholderImageUrl(300, 400, 'Fendi Baguette 1'), getPlaceholderImageUrl(300, 400, 'Fendi Baguette 2'), getPlaceholderImageUrl(300, 400, 'Fendi Baguette 3'), getPlaceholderImageUrl(300, 400, 'Fendi Baguette 4')], description: 'Borsa Fendi Baguette degli inizi degli anni 2000.', condition: 'good', material: 'Canvas and leather', measurements: { width: '26cm', height: '14cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-fendi-baguette' } },
  { id: '38', name: 'Christian Dior Saddle Bag', brand: 'Christian Dior', category: 'bags', color: 'navy blue', size: 'one size', year: 2001, price: 1800, images: [getPlaceholderImageUrl(300, 400, 'Dior Saddle Bag 1'), getPlaceholderImageUrl(300, 400, 'Dior Saddle Bag 2'), getPlaceholderImageUrl(300, 400, 'Dior Saddle Bag 3'), getPlaceholderImageUrl(300, 400, 'Dior Saddle Bag 4')], description: 'Iconica borsa Christian Dior Saddle in blu navy del 2001.', condition: 'excellent', material: 'Canvas', measurements: { width: '20cm', height: '16cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-dior-saddle' } },
  { id: '39', name: 'Louis Vuitton Monogram Pochette', brand: 'Louis Vuitton', category: 'bags', color: 'brown', size: 'one size', year: 1999, price: 750, images: [getPlaceholderImageUrl(300, 400, 'LV Pochette 1'), getPlaceholderImageUrl(300, 400, 'LV Pochette 2'), getPlaceholderImageUrl(300, 400, 'LV Pochette 3'), getPlaceholderImageUrl(300, 400, 'LV Pochette 4')], description: 'Pochette Louis Vuitton con monogramma del 1999.', condition: 'very good', material: 'Canvas', measurements: { width: '21cm', height: '13cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-lv-pochette', vestiaire: 'https://www.vestiairecollective.com/example-lv-pochette' } },
  { id: '40', name: 'Balenciaga City Bag (First Edition)', brand: 'Balenciaga', category: 'bags', color: 'black', size: 'one size', year: 2001, price: 1500, images: [getPlaceholderImageUrl(300, 400, 'Balenciaga City 1'), getPlaceholderImageUrl(300, 400, 'Balenciaga City 2'), getPlaceholderImageUrl(300, 400, 'Balenciaga City 3'), getPlaceholderImageUrl(300, 400, 'Balenciaga City 4')], description: 'Borsa Balenciaga City (prima edizione) nera del 2001.', condition: 'excellent', material: 'Leather', measurements: { width: '38cm', height: '24cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-balenciaga-city' } },
  { id: '41', name: 'Chloé Paddington Bag', brand: 'Chloé', category: 'bags', color: 'brown', size: 'one size', year: 2002, price: 850, images: [getPlaceholderImageUrl(300, 400, 'Chloe Paddington 1'), getPlaceholderImageUrl(300, 400, 'Chloe Paddington 2'), getPlaceholderImageUrl(300, 400, 'Chloe Paddington 3'), getPlaceholderImageUrl(300, 400, 'Chloe Paddington 4')], description: 'Borsa Chloé Paddington marrone del 2002.', condition: 'very good', material: 'Leather', measurements: { width: '300px', height: '28cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-chloe-paddington', vestiaire: 'https://www.vestiairecollective.com/example-chloe-paddington' } },
  { id: '42', name: 'Yves Saint Laurent Rive Gauche Bag', brand: 'Yves Saint Laurent', category: 'bags', color: 'red', size: 'one size', year: 2003, price: 780, images: [getPlaceholderImageUrl(300, 400, 'YSL Rive Gauche 1'), getPlaceholderImageUrl(300, 400, 'YSL Rive Gauche 2'), getPlaceholderImageUrl(300, 400, 'YSL Rive Gauche 3'), getPlaceholderImageUrl(300, 400, 'YSL Rive Gauche 4')], description: 'Borsa Yves Saint Laurent Rive Gauche rossa del 2003.', condition: 'excellent', material: 'Suede', measurements: { width: '30cm', height: '22cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-ysl-rivegauche', vestiaire: 'https://www.vestiairecollective.com/example-ysl-rivegauche' } },
  { id: '43', name: 'Gucci Jackie Bag', brand: 'Gucci', category: 'bags', color: 'black', size: 'one size', year: 2005, price: 1100, images: [getPlaceholderImageUrl(300, 400, 'Gucci Jackie 1'), getPlaceholderImageUrl(300, 400, 'Gucci Jackie 2'), getPlaceholderImageUrl(300, 400, 'Gucci Jackie 3'), getPlaceholderImageUrl(300, 400, 'Gucci Jackie 4')], description: 'Borsa Gucci Jackie nera del 2005.', condition: 'excellent', material: 'Canvas and leather', measurements: { width: '33cm', height: '20cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-gucci-jackie' } },
  { id: '44', name: 'Prada Spazzolato Loafers', brand: 'Prada', category: 'shoes', color: 'black', size: 'XS', year: 1996, price: 480, images: [getPlaceholderImageUrl(300, 400, 'Prada Loafers 1'), getPlaceholderImageUrl(300, 400, 'Prada Loafers 2'), getPlaceholderImageUrl(300, 400, 'Prada Loafers 3'), getPlaceholderImageUrl(300, 400, 'Prada Loafers 4')], description: 'Mocassini Prada Spazzolato neri del 1996.', condition: 'very good', material: 'Brushed leather', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-prada-loafers', vestiaire: 'https://www.vestiairecollective.com/example-prada-loafers' } },
  { id: '45', name: 'Manolo Blahnik Hangisi Pumps', brand: 'Manolo Blahnik', category: 'shoes', color: 'blue', size: 'XS', year: 2008, price: 890, images: [getPlaceholderImageUrl(300, 400, 'Manolo Pumps 1'), getPlaceholderImageUrl(300, 400, 'Manolo Pumps 2'), getPlaceholderImageUrl(300, 400, 'Manolo Pumps 3'), getPlaceholderImageUrl(300, 400, 'Manolo Pumps 4')], description: 'Décolleté Manolo Blahnik Hangisi blu del 2008.', condition: 'excellent', material: 'Satin', featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-manolo-blahnik' } },
  { id: '46', name: 'Jimmy Choo Crystal Sandals', brand: 'Jimmy Choo', category: 'shoes', color: 'silver', size: 'XS', year: 2007, price: 720, images: [getPlaceholderImageUrl(300, 400, 'Jimmy Choo Sandals 1'), getPlaceholderImageUrl(300, 400, 'Jimmy Choo Sandals 2'), getPlaceholderImageUrl(300, 400, 'Jimmy Choo Sandals 3'), getPlaceholderImageUrl(300, 400, 'Jimmy Choo Sandals 4')], description: 'Sandali Jimmy Choo con cristalli argento del 2007.', condition: 'excellent', material: 'Leather and crystals', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-jimmy-choo', vestiaire: 'https://www.vestiairecollective.com/example-jimmy-choo' } },
  { id: '47', name: 'Christian Louboutin Red Soles', brand: 'Christian Louboutin', category: 'shoes', color: 'black', size: 'XS', year: 2009, price: 680, images: [getPlaceholderImageUrl(300, 400, 'Louboutin Red Soles 1'), getPlaceholderImageUrl(300, 400, 'Louboutin Red Soles 2'), getPlaceholderImageUrl(300, 400, 'Louboutin Red Soles 3'), getPlaceholderImageUrl(300, 400, 'Louboutin Red Soles 4')], description: 'Décolleté Christian Louboutin con suola rossa del 2009.', condition: 'very good', material: 'Patent leather', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-louboutin', vestiaire: 'https://www.vestiairecollective.com/example-louboutin' } },
  { id: '48', name: 'Versace Chain Reaction Sneakers', brand: 'Versace', category: 'shoes', color: 'black', size: 'M', year: 2010, price: 780, images: [getPlaceholderImageUrl(300, 400, 'Versace Sneakers 1'), getPlaceholderImageUrl(300, 400, 'Versace Sneakers 2'), getPlaceholderImageUrl(300, 400, 'Versace Sneakers 3'), getPlaceholderImageUrl(300, 400, 'Versace Sneakers 4')], description: 'Sneakers Versace Chain Reaction nere del 2010.', condition: 'excellent', material: 'Mixed materials', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-versace-sneakers', vestiaire: 'https://www.vestiairecollective.com/example-versace-sneakers' } },
  { id: '49', name: 'Gucci Horsebit Loafers (Vintage)', brand: 'Gucci', category: 'shoes', color: 'brown', size: 'S', year: 1995, price: 550, images: [getPlaceholderImageUrl(300, 400, 'Gucci Loafers 1'), getPlaceholderImageUrl(300, 400, 'Gucci Loafers 2'), getPlaceholderImageUrl(300, 400, 'Gucci Loafers 3'), getPlaceholderImageUrl(300, 400, 'Gucci Loafers 4')], description: 'Mocassini Gucci Horsebit vintage marroni del 1995.', condition: 'very good', material: 'Leather', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-gucci-horsebit', vestiaire: 'https://www.vestiairecollective.com/example-gucci-horsebit' } },
  { id: '50', name: 'Chanel Classic Flap Bag', brand: 'Chanel', category: 'bags', color: 'black', size: 'one size', year: 1990, price: 4500, images: [getPlaceholderImageUrl(300, 400, 'Chanel Flap Bag 1'), getPlaceholderImageUrl(300, 400, 'Chanel Flap Bag 2'), getPlaceholderImageUrl(300, 400, 'Chanel Flap Bag 3'), getPlaceholderImageUrl(300, 400, 'Chanel Flap Bag 4')], description: 'Borsa Chanel Classic Flap nera del 1990.', condition: 'excellent', material: 'Lambskin leather', measurements: { width: '26cm', height: '16cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-chanel-flap' } },
  { id: '51', name: 'Hermès Birkin Bag (Pre-owned)', brand: 'Hermès', category: 'bags', color: 'tan', size: 'one size', year: 2005, price: 12000, images: [getPlaceholderImageUrl(300, 400, 'Hermes Birkin 1'), getPlaceholderImageUrl(300, 400, 'Hermes Birkin 2'), getPlaceholderImageUrl(300, 400, 'Hermes Birkin 3'), getPlaceholderImageUrl(300, 400, 'Hermes Birkin 4')], description: 'Borsa Hermès Birkin pre-owned in pelle tan del 2005.', condition: 'very good', material: 'Togo leather', measurements: { width: '35cm', height: '25cm' }, featured: true, type: 'product', purchaseLinks: { vestiaire: 'https://www.vestiairecollective.com/example-hermes-birkin' } },
  { id: '52', name: 'Celine Phantom Cabas', brand: 'Celine', category: 'bags', color: 'grey', size: 'one size', year: 2010, price: 1800, images: [getPlaceholderImageUrl(300, 400, 'Celine Phantom 1'), getPlaceholderImageUrl(300, 400, 'Celine Phantom 2'), getPlaceholderImageUrl(300, 400, 'Celine Phantom 3'), getPlaceholderImageUrl(300, 400, 'Celine Phantom 4')], description: 'Borsa Celine Phantom Cabas grigia del 2010.', condition: 'excellent', material: 'Leather', measurements: { width: '30cm', height: '30cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-celine-cabas', vestiaire: 'https://www.vestiairecollective.com/example-celine-cabas' } },
  { id: '53', name: 'Givenchy Antigona Bag', brand: 'Givenchy', category: 'bags', color: 'black', size: 'one size', year: 2008, price: 1400, images: [getPlaceholderImageUrl(300, 400, 'Givenchy Antigona 1'), getPlaceholderImageUrl(300, 400, 'Givenchy Antigona 2'), getPlaceholderImageUrl(300, 400, 'Givenchy Antigona 3'), getPlaceholderImageUrl(300, 400, 'Givenchy Antigona 4')], description: 'Borsa Givenchy Antigona nera del 2008.', condition: 'excellent', material: 'Leather', measurements: { width: '33cm', height: '28cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-givenchy-antigona', vestiaire: 'https://www.vestiairecollective.com/example-givenchy-antigona' } },
  { id: '54', name: 'Bottega Veneta Intrecciato Bag', brand: 'Bottega Veneta', category: 'bags', color: 'brown', size: 'one size', year: 2006, price: 1600, images: [getPlaceholderImageUrl(300, 400, 'Bottega Intrecciato 1'), getPlaceholderImageUrl(300, 400, 'Bottega Intrecciato 2'), getPlaceholderImageUrl(300, 400, 'Bottega Intrecciato 3'), getPlaceholderImageUrl(300, 400, 'Bottega Intrecciato 4')], description: 'Borsa Bottega Veneta Intrecciato marrone del 2006.', condition: 'excellent', material: 'Leather', measurements: { width: '36cm', height: '26cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-bottega-intrecciato', vestiaire: 'https://www.vestiairecollective.com/example-bottega-intrecciato' } },
  { id: '55', name: 'Loewe Puzzle Bag', brand: 'Loewe', category: 'bags', color: 'blue', size: 'one size', year: 2010, price: 1900, images: [getPlaceholderImageUrl(300, 400, 'Loewe Puzzle 1'), getPlaceholderImageUrl(300, 400, 'Loewe Puzzle 2'), getPlaceholderImageUrl(300, 400, 'Loewe Puzzle 3'), getPlaceholderImageUrl(300, 400, 'Loewe Puzzle 4')], description: 'Borsa Loewe Puzzle blu del 2010.', condition: 'excellent', material: 'Leather', measurements: { width: '29cm', height: '19cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-loewe-puzzle', vestiaire: 'https://www.vestiairecollective.com/example-loewe-puzzle' } },
  { id: '56', name: 'Proenza Schouler PS1 Bag', brand: 'Proenza Schouler', category: 'bags', color: 'grey', size: 'one size', year: 2008, price: 1200, images: [getPlaceholderImageUrl(300, 400, 'PS1 Bag 1'), getPlaceholderImageUrl(300, 400, 'PS1 Bag 2'), getPlaceholderImageUrl(300, 400, 'PS1 Bag 3'), getPlaceholderImageUrl(300, 400, 'PS1 Bag 4')], description: 'Borsa Proenza Schouler PS1 grigia del 2008.', condition: 'excellent', material: 'Leather', measurements: { width: '32cm', height: '25cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-ps1-bag', vestiaire: 'https://www.vestiairecollective.com/example-ps1-bag' } },
  { id: '57', name: 'Acne Studios Canada Scarf', brand: 'Acne Studios', category: 'accessories', color: 'grey', size: 'one size', year: 2010, price: 150, images: [getPlaceholderImageUrl(300, 400, 'Acne Scarf 1'), getPlaceholderImageUrl(300, 400, 'Acne Scarf 2'), getPlaceholderImageUrl(300, 400, 'Acne Scarf 3'), getPlaceholderImageUrl(300, 400, 'Acne Scarf 4')], description: 'Sciarpa Acne Studios Canada in grigio del 2010.', condition: 'excellent', material: 'Wool', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-acne-scarf', vestiaire: 'https://www.vestiairecollective.com/example-acne-scarf' } },
  { id: '58', name: 'Ray-Ban Wayfarer Sunglasses', brand: 'Ray-Ban', category: 'accessories', color: 'black', size: 'one size', year: 1990, price: 90, images: [getPlaceholderImageUrl(300, 400, 'Ray-Ban Wayfarer 1'), getPlaceholderImageUrl(300, 400, 'Ray-Ban Wayfarer 2'), getPlaceholderImageUrl(300, 400, 'Ray-Ban Wayfarer 3'), getPlaceholderImageUrl(300, 400, 'Ray-Ban Wayfarer 4')], description: 'Occhiali da sole Ray-Ban Wayfarer neri del 1990.', condition: 'very good', material: 'Acetate', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-rayban-wayfarer', vestiaire: 'https://www.vestiairecollective.com/example-rayban-wayfarer' } },
  { id: '59', name: 'Oakley Frogskins Sunglasses', brand: 'Oakley', category: 'accessories', color: 'green', size: 'one size', year: 1990, price: 80, images: [getPlaceholderImageUrl(300, 400, 'Oakley Frogskins 1'), getPlaceholderImageUrl(300, 400, 'Oakley Frogskins 2'), getPlaceholderImageUrl(300, 400, 'Oakley Frogskins 3'), getPlaceholderImageUrl(300, 400, 'Oakley Frogskins 4')], description: 'Occhiali da sole Oakley Frogskins verdi del 1990.', condition: 'good', material: 'Plastic', featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-oakley-frogskins', vestiaire: 'https://www.vestiairecollective.com/example-oakley-frogskins' } },
  { id: '60', name: 'Supreme Box Logo Tee', brand: 'Supreme', category: 'top', color: 'white', size: 'L', year: 1998, price: 600, images: [getPlaceholderImageUrl(300, 400, 'Supreme Bogo 1'), getPlaceholderImageUrl(300, 400, 'Supreme Bogo 2'), getPlaceholderImageUrl(300, 400, 'Supreme Bogo 3'), getPlaceholderImageUrl(300, 400, 'Supreme Bogo 4')], description: 'T-shirt Supreme Box Logo bianca del 1998.', condition: 'very good', material: 'Cotton', measurements: { chest: '56cm', length: '74cm' }, featured: false, type: 'product', purchaseLinks: { vinted: 'https://www.vinted.it/example-supreme-bogo', vestiaire: 'https://www.vestiairecollective.com/example-supreme-bogo' } },
